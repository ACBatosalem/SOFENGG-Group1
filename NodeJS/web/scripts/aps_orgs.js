$(document).ready(function() {
    ...
    $('.delete-org').on('click', function(){
    	var deletedRow = this;
    	modalMessage("Are you sure you want to change status of this organization?",
    			"No",
    			function(){
    				$("#modal-action").remove();
    			},
    			...
    			function(){
                    ...
                    if(text == 'activate')
                        ...
                        status = 'active';
                    console.log(status);
                    var newStatus = changeStatusOrg(orgID,status);
                    console.log(newStatus);
                    if(status == 'active')
                        $(deletedRow).text('activate');
                    else if (status == 'inactive')
                        $(deletedRow).text('deactivate');
    		        $("#modal-action").remove();
    			});
    });
